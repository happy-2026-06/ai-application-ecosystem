...
class UpdateUserRequest(BaseModel):
    """Request body for updating a user (avoids query params in logs)."""
...
async def update_user(
    ...
    """Update user status or role (admin only). Uses request body for security."""
...
async def get_dashboard(
    ...
    """Get system dashboard statistics (admin only) — optimized single-query."""
    # Consolidate user and document stats into one query each
