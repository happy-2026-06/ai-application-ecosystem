...
.av-item { width:48px; height:48px; display:flex; align-items:center; justify-content:center; font-size:26px; border-radius:10px; cursor:pointer; transition:all .15s; border:2px solid transparent; background:#F1F5F9; }
.av-item:hover { transform:scale(1.1); background:#E2E8F0; }
.av-item.sel { border-color:#2563EB; background:#DBEAFE; transform:scale(1.12); }
[data-theme="dark"] .set-page h2,[data-theme="dark"] .set-section h3 { color: #eee; }
[data-theme="dark"] .av-item { background: #1E293B; }
[data-theme="dark"] .av-item:hover { background: #334155; }
[data-theme="dark"] .av-item.sel { background: rgba(37,99,235,.25); border-color:#2563EB; }
</style>
