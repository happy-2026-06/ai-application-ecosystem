...
.reg-left::before{content:'';position:absolute;top:-80px;right:-80px;width:240px;height:240px;background:rgba(37,99,235,.08);border-radius:50%;}
.reg-left::after{content:'';position:absolute;bottom:-60px;left:-60px;width:200px;height:200px;background:rgba(37,99,235,.06);border-radius:50%;}
...
.feat{padding:10px 14px;border-radius:10px;background:rgba(255,255,255,.06);font-size:14px;color:#bcc8e0;display:flex;align-items:center;gap:6px;backdrop-filter:blur(8px);transition:all .2s;cursor:default;}
.feat:hover{transform:translateY(-2px);background:rgba(255,255,255,.12);}
