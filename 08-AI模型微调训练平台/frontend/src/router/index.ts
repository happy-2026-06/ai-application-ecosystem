...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/forgot-password', name: 'ForgotPassword', component: () => import('../views/ForgotPasswordView.vue'), meta: { guest: true } },
  {
    ...
    children: [
      { path: '', redirect: '/lab' },
      { path: 'lab', name: 'TrainingLab', component: () => import('../views/TrainingLab.vue') },
      { path: 'lab/tasks/:id', name: 'TaskDetail', component: () => import('../views/TaskDetail.vue') },
