<template>
  <div class="app-shell">
    ...
    <header class="top-nav">
      <div class="tn-left">
        <span class="tn-brand" @click="$router.push('/lab')">
          <span class="tn-logo">🧠</span>
          <span class="tn-name">模型微调</span>
        </span>
        <nav class="tn-nav">
          <span
...
const currentRoute = computed(() => {
  ...
  if (name === 'TrainingLab') return 'lab'
...
.tn-item:hover { background: rgba(245,158,11,.06); color: #f59e0b; }
.tn-item.active { background: rgba(245,158,11,.1); color: #f59e0b; font-weight: 700; }
...
.tn-user-badge {
  ...
  background: rgba(245,158,11,.04); margin: 0 4px;
}
.tn-user-badge:hover { background: rgba(245,158,11,.1); color: #f59e0b; }
...
[data-theme="dark"] .tn-item:hover { background: rgba(245,158,11,.08); color: #fbbf24; }
[data-theme="dark"] .tn-item.active { background: rgba(245,158,11,.15); color: #fbbf24; }
[data-theme="dark"] .tn-user-badge { color: #94a3b8; background: rgba(245,158,11,.04); }
[data-theme="dark"] .tn-user-badge:hover { background: rgba(245,158,11,.1); color: #fbbf24; }
