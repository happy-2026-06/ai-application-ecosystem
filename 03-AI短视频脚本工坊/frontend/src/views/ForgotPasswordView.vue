...
.fp-page {
  ...
  height: 100vh;
  background: linear-gradient(135deg, #1A1A24 0%, #2A2A38 40%, #3A3020 100%);
  position: relative;
  overflow: hidden;
}
...
.fp-page::before {
  ...
  width: 400px;
  height: 400px;
  background: radial-gradient(circle, rgba(200,169,81,.10), transparent 70%);
  border-radius: 50%;
...
[data-theme="dark"] .fp-page {
  background: linear-gradient(135deg, #0A0A12 0%, #14141C 40%, #1E1A12 100%);
}
