...
.set-page h2 { margin:0 0 24px; font-size:22px; color: #1A0F2E; }
.set-section { margin:20px 0; padding: 20px; background: #fff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,.04); }
.set-section h3 { margin:0 0 4px; font-size:16px; color: #1A0F2E; }
.desc { color:#999; margin:0 0 14px; font-size:13px; }
.avatar-grid { display:flex; flex-wrap:wrap; gap:8px; }
.av-item { width:48px; height:48px; display:flex; align-items:center; justify-content:center; font-size:26px; border-radius:10px; cursor:pointer; transition:all .15s; border:2px solid transparent; background:#faf6f2; }
.av-item:hover { transform:scale(1.1); background:#fff0e0; }
.av-item.sel { border-color:#FF6B35; background:#FFF0EB; transform:scale(1.12); box-shadow: 0 2px 8px rgba(255,107,53,.2); }

[data-theme="dark"] .set-page { background: transparent; }
[data-theme="dark"] .set-page h2,[data-theme="dark"] .set-section h3 { color: #eee; }
[data-theme="dark"] .set-section { background: #1a0f1e; box-shadow: 0 2px 8px rgba(0,0,0,.2); }
[data-theme="dark"] .av-item { background: #120a18; }
[data-theme="dark"] .av-item:hover { background: #2a1528; }
[data-theme="dark"] .av-item.sel { background: rgba(255,107,53,.15); border-color: #FF6B35; box-shadow: 0 2px 8px rgba(255,107,53,.15); }
</style>
