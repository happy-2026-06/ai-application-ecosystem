    ...
    <div class="reg-left">
      <div class="left-inner">
        ...
        <div class="feat-list">
          ...
          <div class="feat anim-fade-in-up anim-delay-3"><span>📝</span> 图文文案</div>
          <div class="feat anim-fade-in-up anim-delay-4"><span>📊</span> 数据分析</div>
        </div>
      </div>
    </div>
    <div class="reg-right">
...
.reg-left::before{content:'';position:absolute;top:-100px;right:-100px;width:300px;height:300px;background:radial-gradient(circle,rgba(255,107,53,.12),transparent 70%);border-radius:50%;animation:pulse-glow 4.5s ease-in-out infinite;}
.reg-left::after{content:'';position:absolute;bottom:-80px;left:-80px;width:260px;height:260px;background:radial-gradient(circle,rgba(225,29,72,.08),transparent 70%);border-radius:50%;animation:pulse-glow 5.5s ease-in-out infinite reverse;}
...
.left-inner>p{color:#ffc4a8;margin:0 0 36px;font-size:15px;}
.feat-list{display:grid;grid-template-columns:1fr 1fr;gap:10px;max-width:340px;margin:0 auto;}
.feat{padding:12px 16px;border-radius:12px;background:rgba(255,255,255,.06);font-size:14px;color:#d4c8e0;display:flex;align-items:center;gap:8px;backdrop-filter:blur(8px);transition:all 0.3s var(--ease-smooth);border:1px solid rgba(255,255,255,.03);cursor:default;}
.feat:hover{transform:translateY(-3px);background:rgba(255,107,53,.12);border-color:rgba(255,107,53,.2);color:#e8d8f0;}
.feat span{font-size:20px;}
.reg-right{width:520px;display:flex;align-items:center;justify-content:center;padding:40px;background:radial-gradient(ellipse at 20% 50%,rgba(255,107,53,.03) 0%,transparent 50%),radial-gradient(ellipse at 80% 20%,rgba(255,107,53,.02) 0%,transparent 50%),#fff;position:relative;z-index:1;}
...
.reg-btn{height:50px!important;font-size:16px!important;font-weight:700!important;border-radius:14px!important;background:linear-gradient(135deg,#FF8C42,#FF6B35,#E55A2B)!important;border:none!important;position:relative;overflow:hidden;letter-spacing:2px;}
...
.reg-btn:hover{transform:translateY(-1px);box-shadow:0 8px 24px rgba(255,107,53,.35)!important;}
.reg-btn:active{transform:translateY(0);}
.extra{text-align:center;margin-top:24px;font-size:14px;color:var(--text-secondary);}
[data-theme="dark"] .reg-right{background:radial-gradient(ellipse at 20% 50%,rgba(255,107,53,.04) 0%,transparent 50%),radial-gradient(ellipse at 80% 20%,rgba(255,107,53,.03) 0%,transparent 50%),#0F0A14;}
...
[data-theme="dark"] .feat{color:#9a8aaa;background:rgba(255,255,255,.06);}
[data-theme="dark"] .feat:hover{background:rgba(255,107,53,.12);color:#baaaca;}
